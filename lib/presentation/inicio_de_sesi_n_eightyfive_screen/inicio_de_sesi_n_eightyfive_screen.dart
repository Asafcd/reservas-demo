import 'bloc/inicio_de_sesi_n_eightyfive_bloc.dart';
import 'models/inicio_de_sesi_n_eightyfive_model.dart';
...
class InicioDeSesiNEightyfiveScreen extends StatelessWidget {
  InicioDeSesiNEightyfiveScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNEightyfiveBloc>(
      create: (context) =>
          InicioDeSesiNEightyfiveBloc(InicioDeSesiNEightyfiveState(
        inicioDeSesiNEightyfiveModelObj: InicioDeSesiNEightyfiveModel(),
      ))
            ..add(InicioDeSesiNEightyfiveInitialEvent()),
      child: InicioDeSesiNEightyfiveScreen(),
    );
  }
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "msg_seleccione_a_continuaci_n3".tr,
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: BlocSelector<
                      InicioDeSesiNEightyfiveBloc,
                      InicioDeSesiNEightyfiveState,
                      InicioDeSesiNEightyfiveModel?>(
                    selector: (state) => state.inicioDeSesiNEightyfiveModelObj,
                    builder: (context, inicioDeSesiNEightyfiveModelObj) {
                      return CustomDropDown(
                        ...
                        hintText: "lbl_mes".tr,
                        items:
                            inicioDeSesiNEightyfiveModelObj?.dropdownItemList ??
                                [],
                        onChanged: (value) {
                          context
                              .read<InicioDeSesiNEightyfiveBloc>()
                  ...
                  child: BlocSelector<
                    ...
                    builder: (context, inicioDeSesiNEightyfiveModelObj) {
                      return CustomDropDown(
                        ...
                        hintText: "lbl_a_o".tr,
                        items: inicioDeSesiNEightyfiveModelObj
                                ?.dropdownItemList1 ??
                            [],
                        onChanged: (value) {
                          context
          ...
          SizedBox(height: 15.v),
          BlocBuilder<InicioDeSesiNEightyfiveBloc,
              InicioDeSesiNEightyfiveState>(
