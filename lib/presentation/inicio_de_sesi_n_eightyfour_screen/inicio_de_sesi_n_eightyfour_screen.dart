import '../inicio_de_sesi_n_eightyfour_screen/widgets/widget18_item_widget.dart';
import 'bloc/inicio_de_sesi_n_eightyfour_bloc.dart';
import 'models/inicio_de_sesi_n_eightyfour_model.dart';
...
class InicioDeSesiNEightyfourScreen extends StatelessWidget {
  const InicioDeSesiNEightyfourScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNEightyfourBloc>(
      create: (context) =>
          InicioDeSesiNEightyfourBloc(InicioDeSesiNEightyfourState(
        inicioDeSesiNEightyfourModelObj: InicioDeSesiNEightyfourModel(),
      ))
            ..add(InicioDeSesiNEightyfourInitialEvent()),
      child: InicioDeSesiNEightyfourScreen(),
    );
  }
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: BlocSelector<InicioDeSesiNEightyfourBloc,
                          InicioDeSesiNEightyfourState, TextEditingController?>(
  ...
  Widget _buildSliderWidget(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          BlocBuilder<InicioDeSesiNEightyfourBloc,
            ...
            builder: (context, state) {
              return CarouselSlider.builder(
                ...
                itemCount: state.inicioDeSesiNEightyfourModelObj
                        ?.widget18ItemList.length ??
                    0,
                itemBuilder: (context, index, realIndex) {
                  Widget18ItemModel model = state
                          .inicioDeSesiNEightyfourModelObj
                          ?.widget18ItemList[index] ??
                      Widget18ItemModel();
                  return Widget18ItemWidget(
                    model,
                  );
                },
              );
          ...
          Align(
            alignment: Alignment.bottomCenter,
            child: BlocBuilder<InicioDeSesiNEightyfourBloc,
                InicioDeSesiNEightyfourState>(
              builder: (context, state) {
                return SizedBox(
                  height: 32.v,
                  child: AnimatedSmoothIndicator(
                    ...
                    count: state.inicioDeSesiNEightyfourModelObj
                            ?.widget18ItemList.length ??
                        0,
