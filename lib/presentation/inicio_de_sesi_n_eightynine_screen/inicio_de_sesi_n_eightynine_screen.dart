import 'bloc/inicio_de_sesi_n_eightynine_bloc.dart';
import 'models/inicio_de_sesi_n_eightynine_model.dart';
...
class InicioDeSesiNEightynineScreen extends StatelessWidget {
  const InicioDeSesiNEightynineScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNEightynineBloc>(
      create: (context) =>
          InicioDeSesiNEightynineBloc(InicioDeSesiNEightynineState(
        inicioDeSesiNEightynineModelObj: InicioDeSesiNEightynineModel(),
      ))
            ..add(InicioDeSesiNEightynineInitialEvent()),
      child: InicioDeSesiNEightynineScreen(),
    );
  }
  ...
  Widget _buildFirstNameTextField(BuildContext context) {
    return BlocSelector<InicioDeSesiNEightynineBloc,
        InicioDeSesiNEightynineState, TextEditingController?>(
  ...
  Widget _buildCodeTextField(BuildContext context) {
    return Padding(
      ...
      child: BlocSelector<InicioDeSesiNEightynineBloc,
          InicioDeSesiNEightynineState, TextEditingController?>(
  ...
  /// Section Widget
  Widget _buildExpiresRow(BuildContext context) {
    return BlocSelector<InicioDeSesiNEightynineBloc,
        InicioDeSesiNEightynineState, TextEditingController?>(
      selector: (state) => state.expiresRowController,
      builder: (context, expiresRowController) {
        return CustomFloatingTextField(
          width: 80.h,
          controller: expiresRowController,
  ...
  Widget _buildYearEditText(BuildContext context) {
    return Padding(
      ...
      child: BlocSelector<InicioDeSesiNEightynineBloc,
          InicioDeSesiNEightynineState, TextEditingController?>(
        selector: (state) => state.yearEditTextController,
        builder: (context, yearEditTextController) {
  ...
  Widget _buildUploadCheckBox(BuildContext context) {
    return Align(
      ...
      child: Padding(
        padding: EdgeInsets.only(left: 3.h),
        child: BlocSelector<InicioDeSesiNEightynineBloc,
            InicioDeSesiNEightynineState, bool?>(
          ...
          builder: (context, uploadCheckBox) {
            return CustomCheckboxButton(
              ...
              onChange: (value) {
                context
                    .read<InicioDeSesiNEightynineBloc>()
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      height: 852.v,
      centerTitle: true,
      title: BlocSelector<InicioDeSesiNEightynineBloc,
          InicioDeSesiNEightynineState, TextEditingController?>(
