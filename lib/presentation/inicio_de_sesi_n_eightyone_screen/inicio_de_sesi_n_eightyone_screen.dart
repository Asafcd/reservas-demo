import '../inicio_de_sesi_n_eightyone_screen/widgets/widget15_item_widget.dart';
import 'bloc/inicio_de_sesi_n_eightyone_bloc.dart';
import 'models/inicio_de_sesi_n_eightyone_model.dart';
...
class InicioDeSesiNEightyoneScreen extends StatelessWidget {
  const InicioDeSesiNEightyoneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNEightyoneBloc>(
      create: (context) =>
          InicioDeSesiNEightyoneBloc(InicioDeSesiNEightyoneState(
        inicioDeSesiNEightyoneModelObj: InicioDeSesiNEightyoneModel(),
      ))
            ..add(InicioDeSesiNEightyoneInitialEvent()),
      child: InicioDeSesiNEightyoneScreen(),
    );
  }
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: _buildPepinillosRow(
                            context,
                            userImage: ImageConstant.imgRectangle1241613,
                            messageText: "msg_queso_2_rebanadas2".tr,
                          ),
                        ),
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 16.h),
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: BlocSelector<InicioDeSesiNEightyoneBloc,
                          InicioDeSesiNEightyoneState, TextEditingController?>(
  ...
  Widget _buildUserStack(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          BlocBuilder<InicioDeSesiNEightyoneBloc, InicioDeSesiNEightyoneState>(
            builder: (context, state) {
              return CarouselSlider.builder(
                ...
                itemCount: state.inicioDeSesiNEightyoneModelObj
                        ?.widget15ItemList.length ??
                    0,
                itemBuilder: (context, index, realIndex) {
                  Widget15ItemModel model = state.inicioDeSesiNEightyoneModelObj
                          ?.widget15ItemList[index] ??
                      Widget15ItemModel();
                  return Widget15ItemWidget(
                    model,
                  );
                },
              );
          ...
          Align(
            alignment: Alignment.bottomCenter,
            child: BlocBuilder<InicioDeSesiNEightyoneBloc,
              ...
              builder: (context, state) {
                return SizedBox(
                  ...
                  child: AnimatedSmoothIndicator(
                    ...
                    count: state.inicioDeSesiNEightyoneModelObj
                            ?.widget15ItemList.length ??
                        0,
  ...
  /// Section Widget
  Widget _buildGuardarStack(BuildContext context) {
    return SizedBox(
      height: 414.v,
      width: 412.h,
      child: Stack(
                                    ...
                                    child: RichText(
                                      text: TextSpan(
                                        children: [
                                          ...
                                          TextSpan(
                                            text: "msg_4_rebanadas_de_pepinillo"
                                                .tr,
                                            style: theme.textTheme.bodySmall,
                                          ),
                                        ],
