import '../inicio_de_sesi_n_eightytwo_screen/widgets/widget16_item_widget.dart';
import 'bloc/inicio_de_sesi_n_eightytwo_bloc.dart';
import 'models/inicio_de_sesi_n_eightytwo_model.dart';
...
class InicioDeSesiNEightytwoScreen extends StatelessWidget {
  const InicioDeSesiNEightytwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNEightytwoBloc>(
      create: (context) =>
          InicioDeSesiNEightytwoBloc(InicioDeSesiNEightytwoState(
        inicioDeSesiNEightytwoModelObj: InicioDeSesiNEightytwoModel(),
      ))
            ..add(InicioDeSesiNEightytwoInitialEvent()),
      child: InicioDeSesiNEightytwoScreen(),
    );
  }
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: BlocSelector<InicioDeSesiNEightytwoBloc,
                          InicioDeSesiNEightytwoState, TextEditingController?>(
  ...
  Widget _buildSliderWidget(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          BlocBuilder<InicioDeSesiNEightytwoBloc, InicioDeSesiNEightytwoState>(
            builder: (context, state) {
              return CarouselSlider.builder(
                ...
                itemCount: state.inicioDeSesiNEightytwoModelObj
                        ?.widget16ItemList.length ??
                    0,
                itemBuilder: (context, index, realIndex) {
                  Widget16ItemModel model = state.inicioDeSesiNEightytwoModelObj
                          ?.widget16ItemList[index] ??
                      Widget16ItemModel();
                  return Widget16ItemWidget(
                    model,
                  );
                },
              );
          ...
          Align(
            alignment: Alignment.bottomCenter,
            child: BlocBuilder<InicioDeSesiNEightytwoBloc,
              ...
              builder: (context, state) {
                return SizedBox(
                  ...
                  child: AnimatedSmoothIndicator(
                    ...
                    count: state.inicioDeSesiNEightytwoModelObj
                            ?.widget16ItemList.length ??
                        0,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  _buildBreadRow(
                    context,
                    dynamicText: "lbl_ingredientes".tr,
                  ),
                  Column(
                    children: [
                      Container(
