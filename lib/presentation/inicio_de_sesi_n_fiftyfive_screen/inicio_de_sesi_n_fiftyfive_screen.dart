import '../inicio_de_sesi_n_fiftyfive_screen/widgets/widget5_item_widget.dart';
import 'bloc/inicio_de_sesi_n_fiftyfive_bloc.dart';
import 'models/inicio_de_sesi_n_fiftyfive_model.dart';
...
class InicioDeSesiNFiftyfiveScreen extends StatelessWidget {
  const InicioDeSesiNFiftyfiveScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNFiftyfiveBloc>(
      create: (context) =>
          InicioDeSesiNFiftyfiveBloc(InicioDeSesiNFiftyfiveState(
        inicioDeSesiNFiftyfiveModelObj: InicioDeSesiNFiftyfiveModel(),
      ))
            ..add(InicioDeSesiNFiftyfiveInitialEvent()),
      child: InicioDeSesiNFiftyfiveScreen(),
    );
  }
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: BlocSelector<InicioDeSesiNFiftyfiveBloc,
                          InicioDeSesiNFiftyfiveState, TextEditingController?>(
  ...
  Widget _buildUserStack(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          BlocBuilder<InicioDeSesiNFiftyfiveBloc, InicioDeSesiNFiftyfiveState>(
            builder: (context, state) {
              return CarouselSlider.builder(
                ...
                itemCount: state.inicioDeSesiNFiftyfiveModelObj?.widget5ItemList
                        .length ??
                    0,
                itemBuilder: (context, index, realIndex) {
                  Widget5ItemModel model = state.inicioDeSesiNFiftyfiveModelObj
                          ?.widget5ItemList[index] ??
                      Widget5ItemModel();
          ...
          Align(
            alignment: Alignment.bottomCenter,
            child: BlocBuilder<InicioDeSesiNFiftyfiveBloc,
              ...
              builder: (context, state) {
                return SizedBox(
                  ...
                  child: AnimatedSmoothIndicator(
                    ...
                    count: state.inicioDeSesiNFiftyfiveModelObj?.widget5ItemList
                            .length ??
                        0,
  ...
  /// Section Widget
  Widget _buildQuesoRow(BuildContext context) {
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 16.h),
      padding: EdgeInsets.symmetric(
        horizontal: 16.h,
