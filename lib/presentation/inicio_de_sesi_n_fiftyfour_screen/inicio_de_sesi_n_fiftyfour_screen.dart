import '../inicio_de_sesi_n_fiftyfour_screen/widgets/widget4_item_widget.dart';
import 'bloc/inicio_de_sesi_n_fiftyfour_bloc.dart';
import 'models/inicio_de_sesi_n_fiftyfour_model.dart';
...
class InicioDeSesiNFiftyfourScreen extends StatelessWidget {
  const InicioDeSesiNFiftyfourScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNFiftyfourBloc>(
      create: (context) =>
          InicioDeSesiNFiftyfourBloc(InicioDeSesiNFiftyfourState(
        inicioDeSesiNFiftyfourModelObj: InicioDeSesiNFiftyfourModel(),
      ))
            ..add(InicioDeSesiNFiftyfourInitialEvent()),
      child: InicioDeSesiNFiftyfourScreen(),
    );
  }
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: BlocSelector<InicioDeSesiNFiftyfourBloc,
                          InicioDeSesiNFiftyfourState, TextEditingController?>(
  ...
  Widget _buildUserStack(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          BlocBuilder<InicioDeSesiNFiftyfourBloc, InicioDeSesiNFiftyfourState>(
            builder: (context, state) {
              return CarouselSlider.builder(
                ...
                itemCount: state.inicioDeSesiNFiftyfourModelObj?.widget4ItemList
                        .length ??
                    0,
                itemBuilder: (context, index, realIndex) {
                  Widget4ItemModel model = state.inicioDeSesiNFiftyfourModelObj
                          ?.widget4ItemList[index] ??
                      Widget4ItemModel();
                  return Widget4ItemWidget(
                    model,
                  );
                },
              );
          ...
          Align(
            alignment: Alignment.bottomCenter,
            child: BlocBuilder<InicioDeSesiNFiftyfourBloc,
              ...
              builder: (context, state) {
                return SizedBox(
                  ...
                  child: AnimatedSmoothIndicator(
                    ...
                    count: state.inicioDeSesiNFiftyfourModelObj?.widget4ItemList
                            .length ??
                        0,
