import 'bloc/inicio_de_sesi_n_fiftynine_bloc.dart';
import 'models/inicio_de_sesi_n_fiftynine_model.dart';
import 'package:asaf_s_application2/core/app_export.dart';
import 'package:asaf_s_application2/widgets/custom_outlined_button.dart';
import 'package:flutter/material.dart';

// ignore_for_file: must_be_immutable
class InicioDeSesiNFiftynineDialog extends StatelessWidget {
  const InicioDeSesiNFiftynineDialog({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNFiftynineBloc>(
      create: (context) =>
          InicioDeSesiNFiftynineBloc(InicioDeSesiNFiftynineState(
        inicioDeSesiNFiftynineModelObj: InicioDeSesiNFiftynineModel(),
      ))
            ..add(InicioDeSesiNFiftynineInitialEvent()),
      child: InicioDeSesiNFiftynineDialog(),
    );
  }
