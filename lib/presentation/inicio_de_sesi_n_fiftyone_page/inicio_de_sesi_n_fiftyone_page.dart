import 'bloc/inicio_de_sesi_n_fiftyone_bloc.dart';
import 'models/inicio_de_sesi_n_fiftyone_model.dart';
import 'package:asaf_s_application2/core/app_export.dart';
import 'package:asaf_s_application2/widgets/custom_elevated_button.dart';
import 'package:flutter/material.dart';

// ignore_for_file: must_be_immutable
class InicioDeSesiNFiftyonePage extends StatefulWidget {
  const InicioDeSesiNFiftyonePage({Key? key})
      : super(
          key: key,
        );

  @override
  InicioDeSesiNFiftyonePageState createState() =>
      InicioDeSesiNFiftyonePageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNFiftyoneBloc>(
      create: (context) => InicioDeSesiNFiftyoneBloc(InicioDeSesiNFiftyoneState(
        inicioDeSesiNFiftyoneModelObj: InicioDeSesiNFiftyoneModel(),
      ))
        ..add(InicioDeSesiNFiftyoneInitialEvent()),
      child: InicioDeSesiNFiftyonePage(),
    );
  }
}

class InicioDeSesiNFiftyonePageState extends State<InicioDeSesiNFiftyonePage>
    with AutomaticKeepAliveClientMixin<InicioDeSesiNFiftyonePage> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<InicioDeSesiNFiftyoneBloc, InicioDeSesiNFiftyoneState>(
