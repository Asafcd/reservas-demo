import '../inicio_de_sesi_n_fiftysix_screen/widgets/widget6_item_widget.dart';
import 'bloc/inicio_de_sesi_n_fiftysix_bloc.dart';
import 'models/inicio_de_sesi_n_fiftysix_model.dart';
...
class InicioDeSesiNFiftysixScreen extends StatelessWidget {
  const InicioDeSesiNFiftysixScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNFiftysixBloc>(
      create: (context) => InicioDeSesiNFiftysixBloc(InicioDeSesiNFiftysixState(
        inicioDeSesiNFiftysixModelObj: InicioDeSesiNFiftysixModel(),
      ))
        ..add(InicioDeSesiNFiftysixInitialEvent()),
      child: InicioDeSesiNFiftysixScreen(),
    );
  }
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: BlocSelector<InicioDeSesiNFiftysixBloc,
                          InicioDeSesiNFiftysixState, TextEditingController?>(
  ...
  Widget _buildUserStack(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          BlocBuilder<InicioDeSesiNFiftysixBloc, InicioDeSesiNFiftysixState>(
            builder: (context, state) {
              return CarouselSlider.builder(
                ...
                itemCount: state.inicioDeSesiNFiftysixModelObj?.widget6ItemList
                        .length ??
                    0,
                itemBuilder: (context, index, realIndex) {
                  Widget6ItemModel model = state.inicioDeSesiNFiftysixModelObj
                          ?.widget6ItemList[index] ??
                      Widget6ItemModel();
                  return Widget6ItemWidget(
                    model,
                  );
                },
              );
          ...
          Align(
            alignment: Alignment.bottomCenter,
            child: BlocBuilder<InicioDeSesiNFiftysixBloc,
              ...
              builder: (context, state) {
                return SizedBox(
                  ...
                  child: AnimatedSmoothIndicator(
                    ...
                    count: state.inicioDeSesiNFiftysixModelObj?.widget6ItemList
                            .length ??
                        0,
