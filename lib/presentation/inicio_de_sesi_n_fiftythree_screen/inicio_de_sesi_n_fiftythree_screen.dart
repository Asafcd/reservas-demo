import '../inicio_de_sesi_n_fiftythree_screen/widgets/widget3_item_widget.dart';
import 'bloc/inicio_de_sesi_n_fiftythree_bloc.dart';
import 'models/inicio_de_sesi_n_fiftythree_model.dart';
...
class InicioDeSesiNFiftythreeScreen extends StatelessWidget {
  const InicioDeSesiNFiftythreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNFiftythreeBloc>(
      create: (context) =>
          InicioDeSesiNFiftythreeBloc(InicioDeSesiNFiftythreeState(
        inicioDeSesiNFiftythreeModelObj: InicioDeSesiNFiftythreeModel(),
      ))
            ..add(InicioDeSesiNFiftythreeInitialEvent()),
      child: InicioDeSesiNFiftythreeScreen(),
    );
  }
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: BlocSelector<InicioDeSesiNFiftythreeBloc,
                          InicioDeSesiNFiftythreeState, TextEditingController?>(
  ...
  Widget _buildUserStack(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          BlocBuilder<InicioDeSesiNFiftythreeBloc,
            ...
            builder: (context, state) {
              return CarouselSlider.builder(
                ...
                itemCount: state.inicioDeSesiNFiftythreeModelObj
                        ?.widget3ItemList.length ??
                    0,
                itemBuilder: (context, index, realIndex) {
                  Widget3ItemModel model = state.inicioDeSesiNFiftythreeModelObj
                          ?.widget3ItemList[index] ??
                      Widget3ItemModel();
          ...
          Align(
            alignment: Alignment.bottomCenter,
            child: BlocBuilder<InicioDeSesiNFiftythreeBloc,
                InicioDeSesiNFiftythreeState>(
              builder: (context, state) {
                return SizedBox(
                  height: 32.v,
                  child: AnimatedSmoothIndicator(
                    ...
                    count: state.inicioDeSesiNFiftythreeModelObj
                            ?.widget3ItemList.length ??
                        0,
