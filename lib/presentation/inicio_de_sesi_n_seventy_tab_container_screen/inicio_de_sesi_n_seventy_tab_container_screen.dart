import 'bloc/inicio_de_sesi_n_seventy_tab_container_bloc.dart';
import 'models/inicio_de_sesi_n_seventy_tab_container_model.dart';
...
import 'package:asaf_s_application2/presentation/inicio_de_sesi_n_seventy_page/inicio_de_sesi_n_seventy_page.dart';
...
class InicioDeSesiNSeventyTabContainerScreen extends StatefulWidget {
  const InicioDeSesiNSeventyTabContainerScreen({Key? key})
      : super(
          key: key,
        );

  @override
  InicioDeSesiNSeventyTabContainerScreenState createState() =>
      InicioDeSesiNSeventyTabContainerScreenState();
  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNSeventyTabContainerBloc>(
      create: (context) => InicioDeSesiNSeventyTabContainerBloc(
          InicioDeSesiNSeventyTabContainerState(
        inicioDeSesiNSeventyTabContainerModelObj:
            InicioDeSesiNSeventyTabContainerModel(),
      ))
        ..add(InicioDeSesiNSeventyTabContainerInitialEvent()),
      child: InicioDeSesiNSeventyTabContainerScreen(),
    );
  }
}

class InicioDeSesiNSeventyTabContainerScreenState
    extends State<InicioDeSesiNSeventyTabContainerScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<InicioDeSesiNSeventyTabContainerBloc,
        InicioDeSesiNSeventyTabContainerState>(
          ...
          Tab(
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgTodosOnprimary,
                    height: 18.adaptSize,
                    width: 18.adaptSize,
                  ),
                  Padding(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    CustomImageView(
                      imagePath: ImageConstant.imgIconPrimarycontainer18x18,
                      height: 18.adaptSize,
                      width: 18.adaptSize,
                    ),
                    Padding(
