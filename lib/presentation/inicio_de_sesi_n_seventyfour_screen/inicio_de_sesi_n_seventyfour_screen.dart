import 'bloc/inicio_de_sesi_n_seventyfour_bloc.dart';
import 'models/inicio_de_sesi_n_seventyfour_model.dart';
...
class InicioDeSesiNSeventyfourScreen extends StatelessWidget {
  InicioDeSesiNSeventyfourScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNSeventyfourBloc>(
      create: (context) =>
          InicioDeSesiNSeventyfourBloc(InicioDeSesiNSeventyfourState(
        inicioDeSesiNSeventyfourModelObj: InicioDeSesiNSeventyfourModel(),
      ))
            ..add(InicioDeSesiNSeventyfourInitialEvent()),
      child: InicioDeSesiNSeventyfourScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<InicioDeSesiNSeventyfourBloc,
        InicioDeSesiNSeventyfourState>(
