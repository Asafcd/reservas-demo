import 'bloc/inicio_de_sesi_n_sixtysix_bloc.dart';
import 'models/inicio_de_sesi_n_sixtysix_model.dart';
...
class InicioDeSesiNSixtysixScreen extends StatelessWidget {
  const InicioDeSesiNSixtysixScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNSixtysixBloc>(
      create: (context) => InicioDeSesiNSixtysixBloc(InicioDeSesiNSixtysixState(
        inicioDeSesiNSixtysixModelObj: InicioDeSesiNSixtysixModel(),
      ))
        ..add(InicioDeSesiNSixtysixInitialEvent()),
      child: InicioDeSesiNSixtysixScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<InicioDeSesiNSixtysixBloc, InicioDeSesiNSixtysixState>(
  ...
  Widget _buildInvitadoCounter1(BuildContext context) {
    return BlocSelector<InicioDeSesiNSixtysixBloc, InicioDeSesiNSixtysixState,
