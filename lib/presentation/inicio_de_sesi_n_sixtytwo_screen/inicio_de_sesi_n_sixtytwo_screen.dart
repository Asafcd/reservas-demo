import '../inicio_de_sesi_n_sixtytwo_screen/widgets/nestedrows_item_widget.dart';
import 'bloc/inicio_de_sesi_n_sixtytwo_bloc.dart';
import 'models/inicio_de_sesi_n_sixtytwo_model.dart';
...
class InicioDeSesiNSixtytwoScreen extends StatelessWidget {
  const InicioDeSesiNSixtytwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNSixtytwoBloc>(
      create: (context) => InicioDeSesiNSixtytwoBloc(InicioDeSesiNSixtytwoState(
        inicioDeSesiNSixtytwoModelObj: InicioDeSesiNSixtytwoModel(),
      ))
        ..add(InicioDeSesiNSixtytwoInitialEvent()),
      child: InicioDeSesiNSixtytwoScreen(),
    );
  }
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      BlocSelector<
                          InicioDeSesiNSixtytwoBloc,
                          InicioDeSesiNSixtytwoState,
                          InicioDeSesiNSixtytwoModel?>(
                        selector: (state) =>
                            state.inicioDeSesiNSixtytwoModelObj,
                        builder: (context, inicioDeSesiNSixtytwoModelObj) {
                          return CustomDropDown(
                            ...
                            items: inicioDeSesiNSixtytwoModelObj
                                    ?.dropdownItemList ??
                                [],
                            onChanged: (value) {
                              context
                                  .read<InicioDeSesiNSixtytwoBloc>()
          ...
          Align(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16.v),
                BlocSelector<InicioDeSesiNSixtytwoBloc,
                    InicioDeSesiNSixtytwoState, InicioDeSesiNSixtytwoModel?>(
                  selector: (state) => state.inicioDeSesiNSixtytwoModelObj,
                  builder: (context, inicioDeSesiNSixtytwoModelObj) {
                    return ListView.separated(
                      ...
                      itemCount: inicioDeSesiNSixtytwoModelObj
                              ?.nestedrowsItemList.length ??
                          0,
                      itemBuilder: (context, index) {
                        NestedrowsItemModel model =
                            inicioDeSesiNSixtytwoModelObj
                                    ?.nestedrowsItemList[index] ??
                                NestedrowsItemModel();
                        return NestedrowsItemWidget(
                          model,
                        );
                      },
                    );
