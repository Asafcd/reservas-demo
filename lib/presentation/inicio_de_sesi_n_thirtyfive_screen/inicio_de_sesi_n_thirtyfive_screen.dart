import 'bloc/inicio_de_sesi_n_thirtyfive_bloc.dart';
import 'models/inicio_de_sesi_n_thirtyfive_model.dart';
...
class InicioDeSesiNThirtyfiveScreen extends StatelessWidget {
  const InicioDeSesiNThirtyfiveScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNThirtyfiveBloc>(
      create: (context) =>
          InicioDeSesiNThirtyfiveBloc(InicioDeSesiNThirtyfiveState(
        inicioDeSesiNThirtyfiveModelObj: InicioDeSesiNThirtyfiveModel(),
      ))
            ..add(InicioDeSesiNThirtyfiveInitialEvent()),
      child: InicioDeSesiNThirtyfiveScreen(),
    );
  }
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  _buildExpiresTextField(context),
  ...
  Widget _buildFirstNameTextField(BuildContext context) {
    return BlocSelector<InicioDeSesiNThirtyfiveBloc,
        InicioDeSesiNThirtyfiveState, TextEditingController?>(
  ...
  Widget _buildCodeTextField(BuildContext context) {
    return Padding(
      ...
      child: BlocSelector<InicioDeSesiNThirtyfiveBloc,
          InicioDeSesiNThirtyfiveState, TextEditingController?>(
  ...
  Widget _buildUploadCheckBox(BuildContext context) {
    return Align(
      ...
      child: Padding(
        ...
        child: BlocSelector<InicioDeSesiNThirtyfiveBloc,
            InicioDeSesiNThirtyfiveState, bool?>(
          ...
          builder: (context, uploadCheckBox) {
            return CustomCheckboxButton(
              ...
              onChange: (value) {
                context
                    .read<InicioDeSesiNThirtyfiveBloc>()
  ...
  /// Section Widget
  Widget _buildExpiresTextField(BuildContext context) {
    return BlocSelector<InicioDeSesiNThirtyfiveBloc,
        InicioDeSesiNThirtyfiveState, TextEditingController?>(
      selector: (state) => state.expiresTextFieldController,
      builder: (context, expiresTextFieldController) {
        return CustomFloatingTextField(
          width: 80.h,
          controller: expiresTextFieldController,
  ...
  /// Section Widget
  Widget _buildYearTextField(BuildContext context) {
    return Padding(
      ...
      child: BlocSelector<InicioDeSesiNThirtyfiveBloc,
          InicioDeSesiNThirtyfiveState, TextEditingController?>(
        selector: (state) => state.yearTextFieldController,
        builder: (context, yearTextFieldController) {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      height: 852.v,
      centerTitle: true,
      title: BlocSelector<InicioDeSesiNThirtyfiveBloc,
          InicioDeSesiNThirtyfiveState, TextEditingController?>(
