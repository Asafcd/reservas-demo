import 'bloc/inicio_de_sesi_n_thirtynine_bloc.dart';
import 'models/inicio_de_sesi_n_thirtynine_model.dart';
import 'package:asaf_s_application2/core/app_export.dart';
import 'package:asaf_s_application2/widgets/custom_outlined_button.dart';
import 'package:flutter/material.dart';

// ignore_for_file: must_be_immutable
class InicioDeSesiNThirtynineDialog extends StatelessWidget {
  const InicioDeSesiNThirtynineDialog({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNThirtynineBloc>(
      create: (context) =>
          InicioDeSesiNThirtynineBloc(InicioDeSesiNThirtynineState(
        inicioDeSesiNThirtynineModelObj: InicioDeSesiNThirtynineModel(),
      ))
            ..add(InicioDeSesiNThirtynineInitialEvent()),
      child: InicioDeSesiNThirtynineDialog(),
    );
  }
