import 'bloc/inicio_de_sesi_n_twentyeight_bloc.dart';
import 'models/inicio_de_sesi_n_twentyeight_model.dart';
import 'package:asaf_s_application2/core/app_export.dart';
import 'package:flutter/material.dart';

// ignore_for_file: must_be_immutable
class InicioDeSesiNTwentyeightPage extends StatefulWidget {
  const InicioDeSesiNTwentyeightPage({Key? key})
      : super(
          key: key,
        );

  @override
  InicioDeSesiNTwentyeightPageState createState() =>
      InicioDeSesiNTwentyeightPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<InicioDeSesiNTwentyeightBloc>(
      create: (context) =>
          InicioDeSesiNTwentyeightBloc(InicioDeSesiNTwentyeightState(
        inicioDeSesiNTwentyeightModelObj: InicioDeSesiNTwentyeightModel(),
      ))
            ..add(InicioDeSesiNTwentyeightInitialEvent()),
      child: InicioDeSesiNTwentyeightPage(),
    );
  }
}

class InicioDeSesiNTwentyeightPageState
    extends State<InicioDeSesiNTwentyeightPage>
    with AutomaticKeepAliveClientMixin<InicioDeSesiNTwentyeightPage> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<InicioDeSesiNTwentyeightBloc,
        InicioDeSesiNTwentyeightState>(
  ...
  /// Section Widget
  Widget _buildFotoComida4(BuildContext context) {
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 16.h),
      padding: EdgeInsets.symmetric(
        horizontal: 15.h,
